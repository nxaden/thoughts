...
In all honesty, I was more fascinated by [catAAS](https://cataas.com/) than the actual add-on; a RESTful API service dedicated to providing the API consumers with cat photos. They claim to have over 1900 unique cats in their system, which is nothing short of impressive. 
